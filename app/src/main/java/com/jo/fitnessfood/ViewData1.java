...
//        Sbook_Id = new ArrayList<>();
        ...
        recyclerView.addOnItemTouchListener(new RecyclerView.OnItemTouchListener() {
            ...
            GestureDetector gestureDetector = new GestureDetector(ViewData1.this, new GestureDetector.SimpleOnGestureListener() {
    ...
    public void JSON_HTTP_CALL(){
       String type="0";
        RequestOfJSonArray = new JsonArrayRequest(HTTP_JSON_URL+ "?fitness="+ URLEncoder.encode(HomePage.food)+
                "&diabeteType="+(type)+
                "&time="+ URLEncoder.encode(SelectTime1.time),
        ...
        requestQueue = Volley.newRequestQueue(ViewData1.this);
